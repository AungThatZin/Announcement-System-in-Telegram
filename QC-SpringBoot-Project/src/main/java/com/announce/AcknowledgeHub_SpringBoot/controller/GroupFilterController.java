...
//    }
    ...
    @DeleteMapping("/group/{groupId}/user/{id}")
    public ResponseEntity<?> removeUserFromGroup(@PathVariable int groupId, @PathVariable int id) {
        try {
            groupService.removeUserFromGroup(groupId, id);
